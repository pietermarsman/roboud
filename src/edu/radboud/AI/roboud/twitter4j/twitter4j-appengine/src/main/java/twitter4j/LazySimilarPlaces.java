...
final class LazySimilarPlaces extends LazyResponseList<Place> implements SimilarPlaces {
    ...
    LazySimilarPlaces(HttpResponse res, ObjectFactory factory) {
        super();
        this.res = res;
    ...
    /**
     * Returns the token needed to be able to create a new place  with {@link PlacesGeoResources#createPlace(String, String, String, GeoLocation, String)}.
     *
     * @return token the token needed to be able to create a new place with {@link PlacesGeoResources#createPlace(String, String, String, GeoLocation, String)}
     */
