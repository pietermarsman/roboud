...
public class DataObjectFactoryTest extends TestCase {
    ...
    private static final String deleteJsonText = "{\"delete\":{\"status\":{\"id\":1234,\"id_str\":\"1234\",\"user_id\":3,\"user_id_str\":\"3\"}}}";

    private static final String randomJsonText = "{\"random\":\"meaningless\"}";
