...
import static HttpResponseCode.FORBIDDEN;
import static HttpResponseCode.NOT_ACCEPTABLE;
                ...
                try {
                    ...
                    if (!closed) {
                        if (NO_WAIT == timeToSleep) {
                            if (te.getStatusCode() == HttpResponseCode.FORBIDDEN) {
                            ...
                            if (te.getStatusCode() == HttpResponseCode.NOT_ACCEPTABLE) {
