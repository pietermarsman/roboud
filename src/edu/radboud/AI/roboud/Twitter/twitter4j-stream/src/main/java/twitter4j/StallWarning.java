...
import static ParseUtil.getInt;
...
public final class StallWarning implements Serializable {
    ...
    StallWarning(JSONObject json) throws JSONException {
        ...
        code = ParseUtil.getRawString("code", warning);
        message = ParseUtil.getRawString("message", warning);
        percentFull = ParseUtil.getInt("percent_full", warning);
