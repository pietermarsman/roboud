...
class AsyncTwitterImpl extends TwitterBaseImpl implements AsyncTwitter {
    ...
    public void getRetweets(final long statusId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.RETWEETS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void showStatus(final long id) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.SHOW_STATUS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void destroyStatus(final long statusId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.DESTROY_STATUS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void updateStatus(final String statusText) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.UPDATE_STATUS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void retweetStatus(final long statusId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.RETWEET_STATUS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getOEmbed(final OEmbedRequest req) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.OEMBED, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void search(final Query query) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.SEARCH, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void showDirectMessage(final long id) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.DIRECT_MESSAGE, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void destroyDirectMessage(final long id) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.DESTROY_DIRECT_MESSAGE, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void sendDirectMessage(final long userId, final String text) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.SEND_DIRECT_MESSAGE, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getFriendsIDs(final long cursor) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.FRIENDS_IDS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners)
                    throws TwitterException {
    ...
    public void getFollowersIDs(final long cursor) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.FOLLOWERS_IDS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void lookupFriendships(final long[] ids) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.LOOKUP_FRIENDSHIPS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getIncomingFriendships(final long cursor) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.INCOMING_FRIENDSHIPS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getOutgoingFriendships(final long cursor) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.OUTGOING_FRIENDSHIPS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void createFriendship(final long userId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.CREATE_FRIENDSHIP, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void destroyFriendship(final long userId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.DESTROY_FRIENDSHIP, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void updateFriendship(final long userId
        ...
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.UPDATE_FRIENDSHIP, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void showFriendship(final long sourceId, final long targetId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.SHOW_FRIENDSHIP, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getFriendsList(final long userId, final long cursor) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.FRIENDS_LIST, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getFollowersList(final long userId, final long cursor) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.FOLLOWERS_LIST, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void updateAccountSettings(final Integer trend_locationWoeid, final Boolean sleep_timeEnabled, final String start_sleepTime, final String end_sleepTime, final String time_zone, final String lang) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.UPDATE_ACCOUNT_SETTINGS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void updateProfile(final String name, final String url
        ...
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.UPDATE_PROFILE, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void updateProfileBackgroundImage(final File image
            , final boolean tile) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.UPDATE_PROFILE_BACKGROUND_IMAGE,
                listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners)
                    throws TwitterException {
    ...
    public void updateProfileColors(
        ...
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.UPDATE_PROFILE_COLORS,
                listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners)
                    throws TwitterException {
    ...
    public void updateProfileImage(final File image) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.UPDATE_PROFILE_IMAGE,
                listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners)
                    throws TwitterException {
    ...
    public void createBlock(final long userId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.CREATE_BLOCK, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void destroyBlock(final long userId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.DESTROY_BLOCK, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void lookupUsers(final long[] ids) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.LOOKUP_USERS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void showUser(final long userId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.SHOW_USER, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void searchUsers(final String query, final int page) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.SEARCH_USERS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getContributees(final long userId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.CONTRIBUTEEES, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getContributors(final long userId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.CONTRIBUTORS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
                ResponseList<User> users = twitter.getContributors(userId);
                for (TwitterListener listener : listeners) {
    ...
    public void updateProfileBanner(final File image) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.UPDATE_PROFILE_BANNER, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getUserSuggestions(final String categorySlug) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.USER_SUGGESTIONS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getMemberSuggestions(final String categorySlug) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.MEMBER_SUGGESTIONS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void destroyFavorite(final long id) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.DESTROY_FAVORITE, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void createFavorite(final long id) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.CREATE_FAVORITE, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getUserLists(final long listOwnerUserId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.USER_LISTS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getUserListStatuses(final long listId, final Paging paging) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.USER_LIST_STATUSES, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void destroyUserListMember(final long listId, final long userId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.DESTROY_LIST_MEMBER, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getUserListMemberships(final long cursor) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.USER_LIST_MEMBERSHIPS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getUserListSubscribers(final long listId, final long cursor) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.LIST_SUBSCRIBERS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void createUserListSubscription(final long listId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.SUBSCRIBE_LIST, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void showUserListSubscription(final long listId, final long userId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.CHECK_LIST_SUBSCRIPTION, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void destroyUserListSubscription(final long listId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.UNSUBSCRIBE_LIST, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void createUserListMembers(final long listId, final long[] userIds) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.CREATE_LIST_MEMBERS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void showUserListMembership(final long listId, final long userId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.CHECK_LIST_MEMBERSHIP, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getUserListMembers(final long listId, final long cursor) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.LIST_MEMBERS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void createUserListMember(final long listId, final long userId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.CREATE_LIST_MEMBER, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void destroyUserList(final long listId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.DESTROY_USER_LIST, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void updateUserList(final long listId, final String newListName, final boolean isPublicList, final String newDescription) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.UPDATE_USER_LIST, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void createUserList(final String listName, final boolean isPublicList, final String description) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.CREATE_USER_LIST, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void showUserList(final long listId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.SHOW_USER_LIST, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getUserListSubscriptions(final String listOwnerScreenName, final long cursor) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.USER_LIST_SUBSCRIPTIONS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void showSavedSearch(final int id) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.SAVED_SEARCH, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void createSavedSearch(final String query) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.CREATE_SAVED_SEARCH, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void destroySavedSearch(final int id) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.DESTROY_SAVED_SEARCH, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getGeoDetails(final String id) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.GEO_DETAILS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void reverseGeoCode(final GeoQuery query) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.REVERSE_GEO_CODE, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void searchPlaces(final GeoQuery query) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.SEARCH_PLACES, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getSimilarPlaces(final GeoLocation location, final String name, final String containedWithin
        ...
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.SIMILAR_PLACES, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void createPlace(final String name, final String containedWithin, final String token
        ...
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.CREATE_PLACE, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getPlaceTrends(final int woeid) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.PLACE_TRENDS, listeners) {
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void getClosestTrends(final GeoLocation location) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.CLOSEST_TRENDS, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
    ...
    public void reportSpam(final long userId) {
        getDispatcher().invokeLater(new AsyncTask(TwitterMethod.REPORT_SPAM, listeners) {
            @Override
            public void invoke(List<TwitterListener> listeners) throws TwitterException {
